...
var isFunction = (e) => getConstructor(e) === Function;
...
var support = { audio: "canPlayType" in document.createElement("audio"), video: "canPlayType" in document.createElement("video"), check(e, t, i) {
...
var controls = { getIconUrl() {
  ...
  if (s[is.element(e) ? "insertAdjacentElement" : "insertAdjacentHTML"]("afterbegin", e), is.element(this.elements.controls) || controls.findElements.call(this), !is.empty(this.elements.buttons)) {
    const e2 = (e3) => {
      ...
      Object.defineProperty(e3, "pressed", { enumerable: true, get: () => hasClass(e3, t2), set(i2 = false) {
        toggleClass(e3, t2, i2);
      } });
    };
...
// node_modules/plyr-react/node_modules/react-aptor/esm/useAptor.js
...
function useAptor(ref, configuration, deps) {
  ...
  var instantiate3 = configuration.instantiate, destroy3 = configuration.destroy, getAPI3 = configuration.getAPI, params = configuration.params;
  (0, import_react.useEffect)(function() {
    var instanceReference = instantiate3(domRef.current, params);
    setInstance(instanceReference);
    return function() {
      if (destroy3)
        destroy3(instanceReference, params);
    };
  }, deps);
  var api = (0, import_react.useMemo)(function() {
    return getAPI3(instance, params);
  }, [instance]);
  (0, import_react.useImperativeHandle)(ref, api, [api]);
  return domRef;
}

// node_modules/plyr-react/node_modules/react-aptor/esm/index.js
var esm_default = useAptor;
...
var instantiate = function instantiate2(_, _ref) {
  var options = _ref.options, source2 = _ref.source;
  var plyr = new Plyr(".plyr-react", options || {});
  plyr.source = source2;
  return plyr;
};
var destroy = function destroy2(plyr) {
  if (plyr)
    plyr.destroy();
};
var noop2 = function noop3() {
};
var getAPI = function getAPI2(plyr) {
  if (!plyr)
    return function() {
      return new Proxy({
        plyr: {
...
function usePlyr(ref, _ref2) {
  var source2 = _ref2.source, options = _ref2.options;
  var deps = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : null;
  return esm_default(
    ref,
    {
      instantiate,
    ...
    deps || [options, source2]
  );
}
var Plyr2 = import_react2.default.forwardRef(function(props, ref) {
  var source2 = props.source, _props$options = props.options, options = _props$options === void 0 ? null : _props$options, rest = _objectWithoutProperties(props, _excluded);
  var raptorRef = usePlyr(ref, {
    source: source2,
    options
  });
  return import_react2.default.createElement("video", _extends({
    ref: raptorRef,
...
// dep:plyr-react
var plyr_react_default = Plyr2;
export {
  plyr_react_default as default,
  usePlyr
};
